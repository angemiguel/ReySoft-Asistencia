"""Initial ReySoft-Asistencia SaaS schema.
...
ON attendance_records(student_id, attendance_date)
WHERE status = 'early_pickup';
CREATE INDEX idx_whatsapp_templates_organization_id ON whatsapp_message_templates(organization_id);
CREATE INDEX idx_notifications_user_id ON notifications(user_id);
CREATE INDEX idx_notifications_is_read ON notifications(is_read);
CREATE INDEX idx_subscription_organization_id ON subscription_activations(organization_id);
...
DROP TABLE IF EXISTS subscription_activations;
